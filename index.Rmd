...
output$sumtab <- renderDataTable({
  ...
  totab <- bsbirct %>% 
    ...
    rename(
      ...
      `% meeting selected biointegrity targets (cal)` = Cal_bipassprp,
      `Total sites (val)` = Val_bipassall,
      `% meeting selected biointegrity targets (val)` = Val_bipassprp
    )
