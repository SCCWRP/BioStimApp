...
This table shows the lowest validated biostimulatory thresholds for the selections above. Some biostimulatory variables may not be shown if the thresholds were not valided.   
```{r output}
renderTable({
